...
export const DEMO_MENU_ITEMS = [
  { menuItemGuid: "57bb8c12-fa5c-435d-a22a-7020a962664e", menuGroupGuid: "1bff7e0e-b778-4e2c-94fd-e514d1f15456", name: "Roasted Butternut Squash Soup", description: "Roasted butternut squash soup\n\n*Dairy free, Gluten free, Vegan", price: "12.00", calories: 0, imageUrls: [], allergens: ['Gluten'], sortOrder: 0, modifierGroupsReferences: ["a1b2c3d4-e5f6-7890-1234-567890abcdef"], metadata: { currency: "USD", hasModifiers: true } },
  { menuItemGuid: "d6fc0e41-4d8b-4304-98a4-9b6f794d218d", menuGroupGuid: "1bff7e0e-b778-4e2c-94fd-e514d1f15456", name: "Smoked Salmon Bruschetta", description: "with ricotta, fennel and a drizzle of honey", price: "18.00", calories: 0, imageUrls: [], allergens: [], sortOrder: 1, modifierGroupsReferences: [], metadata: { currency: "USD", hasModifiers: false } },
  { menuItemGuid: "2cb5ee80-efb5-4a20-964f-ac5b64c7ea1d", menuGroupGuid: "1bff7e0e-b778-4e2c-94fd-e514d1f15456", name: "Roasted Butternut Squash Flatbread", description: "Topped with caramelized roasted butternut squash, creamy goat cheese \nand a drizzle of balsamic glaze", price: "19.00", calories: 0, imageUrls: [], allergens: [], sortOrder: 2, modifierGroupsReferences: [], metadata: { currency: "USD", hasModifiers: false } },
  ...
  { menuItemGuid: "e2d58955-dad6-4eb1-b11f-02c03c6b8dcf", menuGroupGuid: "25acf481-79f9-4fe8-be2d-feffe3a8b31c", name: "Sausage and Spinach Calzone", description: "Sausage and Spinach Calzone with Ricotta Cheese", price: "23.00", calories: 0, imageUrls: [], allergens: [], sortOrder: 2, modifierGroupsReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd", "a1a2b3c4-d5e6-7890-1234-567890abcdef"], metadata: { currency: "USD", hasModifiers: true } },
];
...
export const DEMO_MODIFIER_OPTIONS = [
  ...
  // Toppings options for calzones
  { modifierOptionGuid: "f6a7b8c9-d0e1-2345-6789-012345abcdef", name: "Arugula", description: "Fresh arugula leaves", price: "2.00", calories: 10, isDefault: false, modifierGroupReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd"] },
  { modifierOptionGuid: "a7a8b9c0-d1e2-3456-7890-123456abcdef", name: "Pepperoni", description: "Spicy pepperoni slices", price: "2.00", calories: 50, isDefault: false, modifierGroupReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd"] },
  { modifierOptionGuid: "b8a9b0c1-d2e3-4567-8901-234567abcdef", name: "Italian Sausage", description: "Seasoned Italian sausage", price: "2.00", calories: 80, isDefault: false, modifierGroupReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd"] },
  { modifierOptionGuid: "c9a0b1c2-d3e4-5678-9012-345678abcdef", name: "Onions", description: "Caramelized onions", price: "2.00", calories: 15, isDefault: false, modifierGroupReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd"] },
  { modifierOptionGuid: "d0a1b2c3-d4e5-6789-0123-456789abcdef", name: "Black Olives", description: "Sliced black olives", price: "2.00", calories: 20, isDefault: false, modifierGroupReferences: ["e5f6a7b8-c9d0-1234-5678-901234efabcd"] },
  
  // Sauce options for calzones
  { modifierOptionGuid: "e2a3b4c5-d6e7-8901-2345-678901abcdef", name: "Pomodoro Sauce", description: "Classic tomato sauce", price: "0.00", calories: 10, isDefault: true, modifierGroupReferences: ["a1a2b3c4-d5e6-7890-1234-567890abcdef"] },
  { modifierOptionGuid: "f3a4b5c6-d7e8-9012-3456-789012abcdef", name: "Marinara Sauce", description: "Traditional marinara", price: "0.00", calories: 15, isDefault: false, modifierGroupReferences: ["a1a2b3c4-d5e6-7890-1234-567890abcdef"] },
  { modifierOptionGuid: "a4a5b6c7-d8e9-0123-4567-890123abcdef", name: "Pesto Sauce", description: "Basil pesto sauce", price: "2.00", calories: 25, isDefault: false, modifierGroupReferences: ["a1a2b3c4-d5e6-7890-1234-567890abcdef"] },
];
