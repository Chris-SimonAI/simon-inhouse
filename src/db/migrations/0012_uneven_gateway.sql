...
ALTER TABLE "dine_in_restaurants" ADD COLUMN "delivery_fee" numeric(10, 2) DEFAULT '5.00' NOT NULL;--> statement-breakpoint
ALTER TABLE "dine_in_restaurants" ADD COLUMN "service_fee_percent" numeric(5, 2) DEFAULT '20.00' NOT NULL;--> statement-breakpoint
