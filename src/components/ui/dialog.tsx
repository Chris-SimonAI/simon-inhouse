...
function Dialog({
  ...
  const resolvedModal = modal ?? false;
...
function DialogPortal({
  container,
  ...props
}: { container?: HTMLElement | null } & React.ComponentProps<typeof DialogPrimitive.Portal>) {
  ...
  return (
    <DialogPortal data-slot="dialog-portal" container={container}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 absolute top-[35%] left-[50%] z-50 grid w-[80%] translate-x-[-50%] translate-y-[-35%] gap-4 rounded-lg border p-6 shadow-lg duration-200",
          className
        )}
        {...props}
      >
